...
This is me! There can be a few flaws. Firstly, in this dataset, loops are relatively harmless, but can extend run time for much longer in future cases. 
Additionally, I would argue that the first part of the chunk with converting variables may be unnecessary here. If you needed to replicate this chunk to produce similar tables, you'd be including something that affect steps further down the line, but nothing for the table.
I'm choosing to separate the first part as a chunk of its own as a result of this.
...
For this next part, I will use the "aggregate" function in dplyr to very quickly summarize the means.
...
Identical to the first one in terms of esquisser() usage. 
